...
const getOfertaUsuario = async (request, response)=>{
    try {
        let sql = "select u.nombre usuario, u.telefono telefono,p.nombre producto, p.precio_base precio, o.metodos, o.valoroferta, o.estado, o.id_oferta ";
        sql+= "from agropagos.ofertas o inner join agropagos.producto p on o.id_producto = p.id_producto ";
        sql+= "inner join agropagos.usuario u  on p.id_usuario = u.id_usuario where o.cliente=$1;";
...
module.exports = {getOfertaUsuario, savetOfertas, updateOfertas, deleteOfertas};